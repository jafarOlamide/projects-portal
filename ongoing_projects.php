                      ...
                      <div class="row container mb-3">
                        ...
                        <div id="option-select">
                          <ul class="nopadding">
                            ...
                            <li class="option-li"><a href="index.php">Dashboard</a></li>
                 ...
                 <?php
                  ...
                  $query =  "SELECT 
                   ...
                   <div class="project_lists">
                    <a href="ongoing_projects.php?update=<?php echo $project_id; ?>" class="project_links">
                    ...
                    <div id="update_div_header" class="container">
                        <div class="row container" style="padding-left: 10px;">
                           ...
                           <div class="ml-auto row">
                            <?php 
                              show_edit_roject_button();
                            ?>
                              <?php 
                              show_pend_project_button();
                            ?>
                            <?php 
                              show_close_project_button();
                            ?>  
                            </div>
                        </div>
                    </div>
